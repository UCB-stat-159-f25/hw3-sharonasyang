...
#     psd_vals = np.array([1, 2, 2, 1]) 
#     psd = interp1d(freqs, psd_vals, kind='linear', fill_value="extrapolate")
#     dt = 1/4096
#     strain = np.random.randn(4096)
#     print(whiten(strain, psd, dt))
...
#     print("RESULT OF REQSHIFT: ", reqshift(data,fshift=100,sample_rate=4096)[:10])
